...
public class BotClass {
	...
	public void loadchar() {
		try {
			ResultSet rs = SQLDatabase
					.doquery("SELECT * FROM bout_characters WHERE username='" + this.account + "' LIMIT 1");
			if (rs.next()) {
	...
	public String getpacketcinfo() {
		try {
			...
			final String chp = getbyte(this.hp + this.hpb, 2);
			final String giga = getbyte(this.gigas, 4);
			final String attamin = getbyte(this.attmin + this.attminb, 2);
			final String attamax = getbyte(this.attmax + this.attmaxb, 2);
			final String attamintrans = getbyte(this.attmintrans + this.attmintransb, 2);
			final String attamaxtrans = getbyte(this.attmaxtrans + this.attmaxtransb, 2);
			final String stransgauge = getbyte(this.transgauge + this.transgaugeb, 2);
			final String scrit = getbyte(this.crit + this.critb, 2);
			final String sevade = getbyte(this.evade + this.evadeb, 2);
			final String specialtrans = getbyte(this.spectrans + this.spectransb, 2);
			final String sspeed = getbyte(this.speed + this.speedb, 2);
			final String stransdef = getbyte(this.transdef + this.transdefb, 2);
			final String stransbotatt = getbyte(this.transbotatt + this.transbotattb, 2);
			final String stransspeed = getbyte(this.transspeed + this.transspeedb, 2);
			final String rangeatta = getbyte(this.rangeatt + this.rangeattb, 2);
	...
	public void updateBot() {
		SQLDatabase.doupdate("UPDATE `bout_characters` SET " + "`bot` = " + this.bottype + "," + "`exp` = " + this.exp
				...
				+ "`attmin` = " + this.attmin + "," + "`attmax` = " + this.attmax + "," + "`attmintrans` = "
				+ this.attmintrans + "," + "`attmaxtrans` = " + this.attmaxtrans + "," + "`specialtrans` = "
	...
	public void updateInvent() {
		SQLDatabase.doupdate("UPDATE `bout_inventory` SET " + "`item1` = " + this.inventitems[0] + "," + "`item2` = "
				...
				+ this.inventitems[3] + "," + "`item5` = " + this.inventitems[4] + "," + "`item6` = "
				+ this.inventitems[5] + "," + "`item7` = " + this.inventitems[6] + "," + "`item8` = "
	...
	public void updateEquip() {
		SQLDatabase.doupdate("UPDATE `bout_characters` SET " + "`equiphead` = " + this.equipitemspart[0] + ","
				...
				+ "`equipminibot` = " + this.equipitemsgear[0] + "," + "`equipgun` = " + this.equipitemsgear[1] + ","
				+ "`equipefield` = " + this.equipitemsgear[2] + "," + "`equipwing` = " + this.equipitemsgear[3] + ","
				+ "`equipshield` = " + this.equipitemsgear[4] + "," + "`equiparmpart` = " + this.equipitemsgear[5] + ","
				+ "`equipflag1` = " + this.equipitemsgear[6] + "," + "`equipflag2` = " + this.equipitemsgear[7] + ","
				+ "`equippassivskill` = " + this.equipitemspack[0] + "," + "`equipaktivskill` = "
				+ this.equipitemspack[1] + "," + "`equippack` = " + this.equipitemspack[2] + "," + "`equiptransbot` = "
				+ this.equipitemspack[3] + "," + "`equipmerc` = " + this.equipitemspack[4] + "," + "`equipmerc2` = "
