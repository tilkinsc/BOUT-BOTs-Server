        ...
        try
        {
            ...
            switch (cmd)
            {
                ...
                case 0x3A2B: // handle death of character
                {
                    ...
                    pack.setPacket(packet);
                    pack.removeHeader();
                	System.out.println("0: " + pack.getInt(0) + ", 1: " + pack.getInt(1) + ", 2: " + pack.getInt(2) + ", 3: " + pack.getInt(3) + ", 4: " + pack.getInt(4));
                    int who = pack.getInt(0); // I wanna try with TWO computers
                    int monsternum = pack.getInt(1);
                    int monstertyp = 2;
