...
public class Room
{
    ...
    private String[] roomplayer = new String[8]; // names of players in room
    private PrintWriter[] roomsocks = new PrintWriter[8]; // sockets of players in room
    private BotClass[] bot = new BotClass[8]; // bots of players in room
    ...
    private boolean[] roomready = new boolean[8]; // ready players in the lobby room
    private boolean[] roomreadytoplay = new boolean[8];
    private boolean[] dead = new boolean[8];
    private int[] killcount = new int[8]; // player kill counts
    private int[] monster;
    private Sector sector;
    private int lala = 0; // unused random variable
    private int[] items;
    ...
    private Packet getRoomPacket()
    {
        ...
        packet.addByte2((byte) (this.roomnum[1] + 89), this.roomtype);
        ...
        packet.addByte2((byte) this.roomtype, (byte) 0x08);
